...
public class VMAP1PPWatrcrsA extends VMAP1PPFeature implements IWaterArea {
   ...
   * @param type
   */
  public VMAP1PPWatrcrsA(IPolygon polygon, HashMap<String, Object> attributes,
    ...
    this.hyc = getLongAttribute("targetscal");
