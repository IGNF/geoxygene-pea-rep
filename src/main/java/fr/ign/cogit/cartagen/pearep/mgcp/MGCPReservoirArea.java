...
public class MGCPReservoirArea extends MGCPFeature implements IWaterArea {

  // MGCP attributes
  private String ace, ale, cpyrt_note, date_bdi, nam, nfi, nfn, src_date,
      src_info, valid_date, valid_info, tier_note, txt, uid, upd_date,
      upd_info;
  private long acc, ace_eval, ale_eval, coe, fcsubtype, fun, hyp, loc, prc,
      rtp, smc, src_name, upd_name, valid_stat, zval_type, originform,
      targetscal;
  private double area;

  private MGCPLandUseType landUseType;

  public MGCPReservoirArea(IPolygon poly) {
    super();
    this.setGeom(poly);
   ...
   * @param type
   */
  public MGCPReservoirArea(IPolygon poly, HashMap<String, Object> attributes,
      PeaRepDbType type) {
    this(poly);
